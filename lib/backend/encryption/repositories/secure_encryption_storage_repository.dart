...
import 'package:medtalk/backend/encryption/interfaces/secure_encryption_repository_interface.dart';
import 'package:medtalk/backend/encryption/models/crypto_result.dart';
...
class SecureEncryptionStorageRepository implements ISecureEncryptionStorage {
  ...
  SecureEncryptionStorageRepository(
      this._cryptoRepository, this._secureStorageRepository, this.logger);
